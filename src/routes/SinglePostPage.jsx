...
const SinglePostPage = () => {
  ...
  if (!data) return <div className="text-center text-gray-500 py-10">Post not found!</div>;
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-between">
        ...
        <div className="px-4 h-max sticky top-8">
          ...
          <div className="flex flex-col gap-2 text-sm">
            ...
            {["web-design", "development", "biography", "news", "marketing"].map(
              (category) => (
                <Link key={category} className="underline" to={`/categories/${category}`}>
                  {category.replace("-", " ")}
                </Link>
              )
            )}
